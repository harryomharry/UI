...
def offer_export(selected_vendor):
    ...
    while i1 < df_len:
        ...
        if (str(df.ix[i1].imageIDDM)!='nan'  and str(df.ix[i1].imageIDDM)!='None'):
            worksheet.write(i2, 12, df.ix[i1].imageIDDM, left)
            
        if (str(df.ix[i1].imageIDCatalina)!='nan'  and str(df.ix[i1].imageIDCatalina)!='None'):
            worksheet.write(i2, 13, df.ix[i1].imageIDCatalina, left)
